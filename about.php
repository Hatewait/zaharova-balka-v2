              ...
              <div class="timeline-slider__content">
                ...
                <div class="timeline-slider__description">
                  ...
                  <div class="timeline-slider__text-block">
                    ...
                    <p class="text-md-regular text-color-secondary">В 2009 году в урочище Захарова Балка мы создали
                      конный центр «Карачай Хорс», чтобы сохранить и популяризировать аборигенные породы лошадей. За эти
                      годы наши лошади стали настоящими звёздами: они участвовали в фильмах, покоряли
                      интернет-фотографов и открыли новую традицию конной фотографии на Кавказе</p>
                  </div>
    ...
    <section class="promo-video space-xxxl">
      <div class="container">
        <div class="promo-video__wrap">
          <button class="btn-reset promo-video__play-btn">
